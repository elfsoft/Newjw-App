...
public class Rows {
	...
	public void setDowith(String dowith) {
		this.dowith = dowith;
	}
	...
	public String getEndselectionname() {
		return endselectionname;
	}

	public void setEndselectionname(String endselectionname) {
		this.endselectionname = endselectionname;
	}
	...
	public void setRegaindate(String regaindate) {
		this.regaindate = regaindate;
	}
